...
### 1.8.1 - [2025-01-28]
- Changed
    - <UE version="5.5"/> Use latest API introduced in UE 5.5
- Fixed
    - <UE version="5.5"/> Input handling
...
- Changed
    - Using TObjectPtr in favor of raw pointers
- Fixed
    - Interactions that are instant (time <= 0) can no longer get `InteractActive` Gameplay Ability stuck in an active state.
    - Invalid reference for Pawns.
- Removed
