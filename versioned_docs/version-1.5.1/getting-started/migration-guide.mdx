...
After you have checked out the [`TBIA_Demo`](https://drive.google.com/drive/folders/1I7TXOPM-9tHABdhWqy58TAR6-lenSy1E?usp=sharing) project you might want to use its example setup as a base for your own project.
...
### Add Gameplay Tags
In the demo project we also set up some *Gameplay Tags*, so that we can demonstrate to you how to
