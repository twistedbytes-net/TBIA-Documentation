...
flowchart TB
    ...
    IS_INTERACTION_STILL_VALID --> |Not Valid| CANCEL_ABILITY_ASYNC2
    MONTAGE_NEXT_SECTION --> STOP_ASYNC2
    CANCEL_ABILITY_ASYNC2 --> STOP_ASYNC2
    ...
    classDef sty_start_async1 fill:#FBDAA2,color:#B58738;
    classDef sty_stop_async1 fill:#FBDAA2,color:#B58738,stroke-width:3px,stroke:#B58738;
    classDef sty_start_async2 fill:#B1FBA2,color:#4DB538;
    classDef sty_stop_async2 fill:#B1FBA2,color:#4DB538,stroke-width:3px,stroke:#4DB538;
